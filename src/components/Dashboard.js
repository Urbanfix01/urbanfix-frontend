...
// 🌟 NUEVO COMPONENTE: Navbar del Administrador (CON LOGO)
const DashboardNavbar = ({ userEmail, onLogout }) => {
    return (
        <Navbar expand="lg" className="dashboard-navbar" data-bs-theme="dark">
            <Container fluid className="px-4">
                {/* 🎯 CAMBIO CLAVE: Reemplazamos el texto "UrbanFix Admin" por la etiqueta <img> */}
                <Navbar.Brand href="/dashboard">
                    <img 
                        src="/logo.png" // Ruta directa a la carpeta public
                        alt="Urbanfix Logo" 
                        style={{ height: '35px', marginRight: '15px' }} // Estilo para ajustar el tamaño en la barra
                    />
                </Navbar.Brand>
